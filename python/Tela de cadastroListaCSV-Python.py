...
def gerar_csv():
    with open('cadastro_clientes.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(["Nome", "Endereço", "Nº", "Bairro", "Cidade", "UF"])
...
# Additional Buttons
tk.Button(root, text="Limpar Lista", command=limpar_lista, bg='blue', fg='white').grid(row=8, column=0, padx=10, pady=10)
tk.Button(root, text="Gerar CSV", command=gerar_csv, bg='blue', fg='white').grid(row=8, column=1, padx=10, pady=10)
